...
'''
Function for cleaning the donors list file, by dropping all variables that are not listed on the website interface

:df: argument to pass the dataframe including all of the donors
:save_path: where to save the dataframe as CSV file
'''
...
'''
Function for cleaning the campaigns list file, by only including relevant variables for the analysis

:df: argument to pass the dataframe including all of the campaigns
:save_path: where to save the dataframe as CSV file
'''
